...
public class MeddraFreq {
    static final String INDEX_DIR_PATH = "indexes/meddra_freq_index";
    static final String FILE_PATH = "data/MEDDRA/meddra_freq.tsv";
    ...
    public static ArrayList<Document> searchIndicationById(String id, Analyzer analyzer, Directory index, int hits) throws IOException, ParseException {
        ...
        Query query = new TermQuery(new Term("meddra_concept_id", id));
     ...
     * indexer side_effect_name, meddra_concept_id, stitch_compound_id1, stitch_compound_id2
     * @param writer
     * @param file
     * @throws IOException
     */
        ...
        try{
            ...
            while (dataRow != null){
                ...
                if(dataArray.size() >= 10){
                    ...
                    doc.add(new TextField("side_effect_name", dataArray.get(9), Field.Store.NO)); // indexed
                    doc.add(new TextField("meddra_concept_id", dataArray.get(8), Field.Store.NO)); // indexed
